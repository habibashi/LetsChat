        ...
        <div className="navbar bg-navBgColor sticky">
            ...
            <div className="flex">
                {/* <div className="dropdown dropdown-end">
                    <button tabIndex={0} className="btn btn-ghost btn-circle avatar">
                        <div className="w-10 rounded-full">
                            <img src={user?.photo !== null ? user.photo : "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png"} />
                        </div>
                    </button>
                ...
                <button id="dropdownAvatarNameButton" data-dropdown-toggle="dropdownAvatarName" className="flex items-center text-sm font-medium text-gray-900 rounded-full md:mr-0  dark:text-white" type="button">
                    ...
                    <img className="w-8 h-8 mr-2 rounded-full" src={user?.photo !== null ? user?.photo : "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png"} alt="user photo" />
                    {user?.name}
